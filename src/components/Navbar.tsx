import { ChangeEventHandler, FC, FormEvent, useContext, useState } from "react";
import Dropdown from "./Dropdown";
import { StoreContext } from "../store/Store";
import { TOGGLE_MENU_ACT, UPDATE_SEARCH_ACT } from "../store/storeActions";
        ...
        <nav className=" bg-fneucolor-100  border-b border-fneucolor-200">
            <div className="flex flex-row px-4 py-2 h-full w-full max-w-[1280px] justify-around items-center">
                ...
                <div className="hidden md:flex max-w-[500px] gap-2 items-center">
                    <input placeholder="Search" onChange={searchChangeHandler} className="text-base h-fit border border-fneucolor-200 py-1 px-3 rounded-lg w-full font-textfont text-sneucolor-200" />
