        ...
        <nav className=" bg-fneucolor-100  border-b border-fneucolor-200">
            <div className="flex flex-row px-4 py-2 h-full w-full max-w-[1280px] justify-around items-center">
                ...
                <div className="font-textfont">
                    <button className="hidden sm:inline-block m-2 py-1 px-3 transition rounded-lg bg-primecolor-100 hover:bg-primecolor-150 active:bg-primecolor-200 text-fneucolor-100">Save</button>
                    <button className="hidden sm:inline-block m-2 py-1 px-3 transition rounded-lg bg-fneucolor-100 hover:bg-fneucolor-150 active:bg-fneucolor-200 border border-fneucolor-250 text-sneucolor-200">Open</button>
