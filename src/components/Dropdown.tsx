...
const Dropdown:FC = () => {
    ...
    return(
        <div className={`absolute right-3 top-10 w-max flex flex-col gap-2 font-textfont text-sneucolor-150 border border-fneucolor-300 px-2 py-2 rounded-lg bg-fneucolor-100 transition-all ${dropMenu.isVisible ? "block" : "hidden"}`}>
